...
v3.4 核心升级 (基于与人类分析对比优化):
  1. 【底背离/顶背离检测】价格创新低+MACD未创新低 = 动能衰竭实证
  2. 【多级别共振底背离】2+级别同时底背离 = 极高胜率买点
  3. 【信号优先级判定】底背离+联合支撑区 > 二卖成立
  4. 【情景推演/路径分析】强势/中性/弱势三种明日路径
  5. 保留v3.3: 联合区/假突破/二买二卖/传导链/双日/时间窗口
"""
...
def main():
    print("="*60)
    print("缠论分析系统 v3.4 - 底背离检测 + 信号优先级 + 情景推演")
    print("="*60)
    ...
    try:
        ...
        if sp['override_second_sell']:
            print(f"  ⚠️ 底背离信号优先于二卖成立!")
