...
"""
后台数据回补脚本 - 2018-2025年历史数据
日志: logs/supplement_2018_2025.log
"""
...
log_file = '/root/.openclaw/workspace/logs/supplement_2018_2025.log'
...
def main():
    ...
    dates = [d for d in dates if d <= '20251231' and d >= '20180101']
    log(f"共{len(dates)}个交易日 (2018-2025)")
    ...
    stats = {'price': 0, 'valuation': 0, 'errors': 0, 'skipped': len(existing)}
